...
like_button = "<button class='btn btn-warning' id="+ firebase_message_id +" value="+ like +" oncick='updateLike(this.id)'>";
span_with_tag = "<span class = 'glyphocon glyphicon-thumbs-up'>Like:"+like+"</span></button><hr>";
...
function updateLike(message_id){
      ...
      like = documment.getElementById(button_id).value;
